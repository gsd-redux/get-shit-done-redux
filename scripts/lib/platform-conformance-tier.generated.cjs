...
module.exports = {
  ...
  "tests/agent-tools.install.test.cjs",
  ...
  "tests/instruction-surface-disclosure.security.test.cjs",
  ...
  "tests/portable-node-runner.install.test.cjs",
  ...
  "tests/zcode-agent-mcp-grants.install.test.cjs",
  ],
};
